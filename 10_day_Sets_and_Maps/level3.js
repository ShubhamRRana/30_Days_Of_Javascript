...
let newCountry = new Set();
let lang = [];
for (x of countries) {
  newCountry.add(lang.push(x.language));
}
console.log(newCountry.size);
...
// let langSet = new Set(countries);
// let counts = [];
// let count = {};
// for (let l of langSet) {
//   let filtered = countries.filter((lng) => lng === l);
